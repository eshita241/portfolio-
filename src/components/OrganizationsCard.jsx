...
const OrganizationsCard = ({ imgUrl, title, description, gitUrl }) => {
  return (
    <div className='flex flex-col md:flex-row bg-[#181818] rounded-xl overflow-hidden'>
      ...
      <div className='md:w-1/2 relative group h-52 md:h-60 bg-cover' style={{ background: `url(${imgUrl})`, backgroundSize:"cover" }}>
