  ...
  return (
    ...
    <section className='z-[999] relative xsm:mb-28 sm:mb-0'>
        ...
        transition={{
            delay: 1}}
        >
            <a href="#home"><img src={logo} alt="logo" className=" fixed sm:bottom-[1.5rem] xsm:bottom-[100rem] right-[2.5rem] h-10 cursor-pointer"></img></a>
        </motion.div>
        <motion.nav className=" flex fixed left-1/2 sm:top-[1.7rem] sm:h-[initial] xsm:top-[1.3rem] py-0 xsm:h-20"
         ...
         transition={{
             delay: 1}}>
          <ul className='flex flex-wrap justify-center items-center w-full sm:gap-10 px-14 py-3 bg-white bg-opacity-45 rounded-full border-opacity-25 xsm:gap-7 xsm:flex-nowrap'>
