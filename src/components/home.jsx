...
export default function Home() {
  return (
    ...
    transition={{
      delay: 0.6,
          ...
          <h2 className='font-bold text-[2rem] leading-[4.8rem] sm:text-[3.4rem] sm:leading-[5.8rem]  text-text2 opacity-45 tracking-normal flex flex-wrap items-center justify-center font-sans xsm:text-2xl'>I believe in magic & logic</h2>
          <p className='text-center px-[1.9rem] lg:px-[20rem] xl:px-[26rem] md:px-[9rem] sm:px-[10rem] flex flex-wrap items-center justify-center py-5 text-text2 opacity-65 font-mono xsm:px-[0.98rem] xsm:text-xs sm:text-sm'>I am a student studying Information Technology, with big dreams and even bigger love for solving puzzles, be it jigsaw or tech:)</p>
  ...
  <a href="/assets/Eshita_Chokhani_Resume.pdf" target="_blank" rel="noopener noreferrer">
    Resume
  </a>
</button>
          </div>
